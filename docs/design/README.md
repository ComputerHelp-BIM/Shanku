...
| [actionable-qa.md](actionable-qa.md) | Proposed | One finding shape for every check, with select, isolate, zoom, step, ignore and safe fixes; model-health, mark and IS 1893 screening checks. |
