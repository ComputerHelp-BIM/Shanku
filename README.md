...
| `packages/ui` | `@shanku/ui` | 0.10.0 | React components: title bar, ribbon, properties, project browser, view tabs, bottom panel, status bar, app shell |
...
| `apps/web` | `@shanku/web` | 0.20.0 | The Shanku app |
