...
| `packages/engine` | `@shanku/engine` | 0.25.0 | IFC loading in a worker, element model, three.js viewer with Revit navigation and picking |
| `apps/web` | `@shanku/web` | 0.27.0 | The Shanku app |
