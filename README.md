...
| `packages/brand` | `@shanku/brand` | 1.9.0 | Logos, the structural icon set, and the brand book (`BRAND.md`) |
...
| `packages/engine` | `@shanku/engine` | 0.33.0 | IFC loading in a worker, element model, three.js viewer with Revit navigation and picking |
| `apps/web` | `@shanku/web` | 0.43.0 | The Shanku app |
