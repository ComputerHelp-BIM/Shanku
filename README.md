...
| `apps/web` | `@shanku/web` | 0.36.0 | The Shanku app |
| `bridge/revit` | Shanku Bridge for Revit | 0.4.0 | Revit 2025 add-in (C#, .NET 8): pairing, load the model into Shanku, selection sync, parameter editing. Protocol: `docs/bridge/protocol.md` |
