...
| `packages/ui` | `@shanku/ui` | 0.9.1 | React components: title bar, ribbon, properties, project browser, view tabs, bottom panel, status bar, app shell |
...
| `apps/web` | `@shanku/web` | 0.19.1 | The Shanku app |
| `apps/playground` | `@shanku/playground` | 0.1.4 | Component playground with sample data |
