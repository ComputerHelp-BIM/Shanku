...
| `packages/engine` | `@shanku/engine` | 0.31.0 | IFC loading in a worker, element model, three.js viewer with Revit navigation and picking |
| `apps/web` | `@shanku/web` | 0.41.0 | The Shanku app |
