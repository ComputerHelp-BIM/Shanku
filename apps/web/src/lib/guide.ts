...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        releases: [
          { version: '0.30.0', date: '2026-09-24', items: ['What now? in the title bar.', 'BOQ scope (visible, selection, levels) with a scope sentence; steel estimate with range warnings.', 'Help for files that do not open, and view links to share a view.'] },
